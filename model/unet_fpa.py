...
class FPAv2(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.glob = nn.Sequential(nn.AdaptiveAvgPool2d((6, 9)),
...
class Res34Unetv5(nn.Module):
    def __init__(self):
        ...
        # self.center = nn.Sequential(FPAv2(512, 256),
        #                             nn.MaxPool2d(2, 2))
        self.center = nn.Sequential(nn.Conv2d(512, 256, kernel_size=3, padding=1),
                                    nn.BatchNorm2d(256), nn.ELU(True), nn.MaxPool2d(2, 2))
